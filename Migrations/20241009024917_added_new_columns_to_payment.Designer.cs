...
namespace CAEV.PagoLinea.Migrations
{
    ...
    [Migration("20241009024917_added_new_columns_to_payment")]
    partial class added_new_columns_to_payment
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CAEV.PagoLinea.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "Administrador",
                            Password = "$2a$11$w9RlSrL0i.NcQ4ni7ftZV.atNbFOGUCcE1QrmftT5Y0jomWzVmlvG",
